...
/** Prepared and waiting on the shelf — "spremno za preuzimanje". */
export function IconPackage({ className = "w-4 h-4" }) {
  return (
    <svg
      className={className}
      fill="none"
...
/** Cancellation — replaces the old hard-delete trash icon. */
...
/** Reverse a premature transition. */
